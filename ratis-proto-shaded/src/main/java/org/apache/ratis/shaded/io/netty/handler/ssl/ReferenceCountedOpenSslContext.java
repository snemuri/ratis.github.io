...
import org.apache.ratis.shaded.io.netty.internal.tcnative.CertificateVerifier;
...
import static org.apache.ratis.shaded.io.netty.handler.ssl.OpenSsl.DEFAULT_CIPHERS;
import static org.apache.ratis.shaded.io.netty.handler.ssl.OpenSsl.availableJavaCipherSuites;
...
public abstract class ReferenceCountedOpenSslContext extends SslContext implements ReferenceCounted {
    ...
    private static final int DEFAULT_BIO_NON_APPLICATION_BUFFER_SIZE =
            AccessController.doPrivileged(new PrivilegedAction<Integer>() {
                ...
                public Integer run() {
                    return Math.max(1,
                            SystemPropertyUtil.getInt("org.apache.ratis.shaded.io.netty.handler.ssl.openssl.bioNonApplicationBufferSize",
                                                      2048));
                }
            });
