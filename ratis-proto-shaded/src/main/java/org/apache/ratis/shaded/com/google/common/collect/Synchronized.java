      ...
      synchronized (mutex) {
        return map(
            Maps.transformValues(
                delegate().rowMap(),
                new org.apache.ratis.shaded.com.google.common.base.Function<Map<C, V>, Map<C, V>>() {
                  @Override
    ...
    public Map<C, Map<R, V>> columnMap() {
      synchronized (mutex) {
        return map(
            Maps.transformValues(
                delegate().columnMap(),
                new org.apache.ratis.shaded.com.google.common.base.Function<Map<R, V>, Map<R, V>>() {
                  @Override
