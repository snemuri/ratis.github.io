...
public abstract class CallStreamObserver<V> implements StreamObserver<V> {
   ...
   * to the 'inbound' {@link org.apache.ratis.shaded.io.grpc.stub.StreamObserver#onNext(Object)} has completed. If disabled
   ...
   * <ul>
   *   <li>{@link org.apache.ratis.shaded.io.grpc.MethodDescriptor.MethodType#UNARY} operations on both the
   *   client and server.
   *   </li>
   *   <li>{@link org.apache.ratis.shaded.io.grpc.MethodDescriptor.MethodType#CLIENT_STREAMING} operations on the server.
   *   </li>
   *   <li>{@link org.apache.ratis.shaded.io.grpc.MethodDescriptor.MethodType#SERVER_STREAMING} operations on the client.
   *   </li>
   * </ul>
   * </p>
   */
