...
public abstract class ManagedChannelProvider {
  ...
  public static Iterable<ManagedChannelProvider> getCandidatesViaHardCoded() {
    ...
    List<ManagedChannelProvider> list = new ArrayList<ManagedChannelProvider>();
    try {
      list.add(create(Class.forName("org.apache.ratis.shaded.io.grpc.okhttp.OkHttpChannelProvider")));
    } catch (ClassNotFoundException ex) {
      // ignore
    }
    try {
      list.add(create(Class.forName("org.apache.ratis.shaded.io.grpc.netty.NettyChannelProvider")));
    } catch (ClassNotFoundException ex) {
      // ignore
    }
    return list;
