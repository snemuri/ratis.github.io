...
public abstract class AbstractStub<S extends AbstractStub<S>> {
   ...
   *  compressed responses from the server, set the appropriate {@link org.apache.ratis.shaded.io.grpc.DecompressorRegistry}
   *  on the {@link org.apache.ratis.shaded.io.grpc.ManagedChannelBuilder}.
   *
   * @since 1.0.0
   ...
   * {@link org.apache.ratis.shaded.io.grpc.ClientInterceptor} via the CallOptions parameter.
   *
   * @since 1.0.0
