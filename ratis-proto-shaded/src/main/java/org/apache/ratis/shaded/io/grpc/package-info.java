 ...
 *
 * <p>To send an RPC, first create a {@link org.apache.ratis.shaded.io.grpc.Channel} using {@link
 * org.apache.ratis.shaded.io.grpc.ManagedChannelBuilder#forTarget}. When using auto generate Protobuf stubs, the stub class
 ...
 *
 * <p>To receive RPCs, create a {@link org.apache.ratis.shaded.io.grpc.Server} using {@link org.apache.ratis.shaded.io.grpc.ServerBuilder#forPort}.
 ...
 * org.apache.ratis.shaded.io.grpc.ServerBuilder#addService}. Once your server is built, call {@link org.apache.ratis.shaded.io.grpc.Server#start}
