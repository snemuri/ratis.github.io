...
import org.apache.ratis.shaded.io.netty.util.collection.IntCollections;
...
import org.apache.ratis.shaded.io.netty.util.internal.DefaultPriorityQueue;
import org.apache.ratis.shaded.io.netty.util.internal.EmptyPriorityQueue;
import org.apache.ratis.shaded.io.netty.util.internal.MathUtil;
import org.apache.ratis.shaded.io.netty.util.internal.PriorityQueue;
import org.apache.ratis.shaded.io.netty.util.internal.PriorityQueueNode;
...
import static org.apache.ratis.shaded.io.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_MIN_ALLOCATION_CHUNK;
import static org.apache.ratis.shaded.io.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_PRIORITY_WEIGHT;
import static org.apache.ratis.shaded.io.netty.handler.codec.http2.Http2CodecUtil.streamableBytes;
...
public final class WeightedFairQueueByteDistributor implements StreamByteDistributor {
    ...
    static final int INITIAL_CHILDREN_MAP_SIZE =
            max(1, SystemPropertyUtil.getInt("org.apache.ratis.shaded.io.netty.http2.childrenMapSize", 2));
    /**
