...
import static org.apache.ratis.shaded.io.grpc.netty.GrpcSslContexts.NEXT_PROTOCOL_VERSIONS;
...
import org.apache.ratis.shaded.io.grpc.Grpc;
...
import org.apache.ratis.shaded.io.netty.channel.ChannelHandlerAdapter;
...
import org.apache.ratis.shaded.io.netty.handler.codec.http2.Http2ClientUpgradeCodec;
import org.apache.ratis.shaded.io.netty.handler.proxy.HttpProxyHandler;
import org.apache.ratis.shaded.io.netty.handler.proxy.ProxyConnectionEvent;
import org.apache.ratis.shaded.io.netty.handler.proxy.ProxyHandler;
import org.apache.ratis.shaded.io.netty.handler.ssl.OpenSsl;
import org.apache.ratis.shaded.io.netty.handler.ssl.OpenSslEngine;
...
public final class ProtocolNegotiators {
   ...
   * be negotiated, the {@code handler} is added and writes to the {@link org.apache.ratis.shaded.io.netty.channel.Channel}
   ...
   * pipeline writes to the {@link org.apache.ratis.shaded.io.netty.channel.Channel} may happen immediately, even before it
   * is active.
   */
   ...
   * write to a {@link org.apache.ratis.shaded.io.netty.channel.Channel} before we are allowed to write to it officially
  ...
  /**
   * Buffers all writes until the {@link org.apache.ratis.shaded.io.netty.channel.Channel} is active.
   */
