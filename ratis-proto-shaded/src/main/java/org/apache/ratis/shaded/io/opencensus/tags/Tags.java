...
import org.apache.ratis.shaded.io.opencensus.tags.propagation.TagPropagationComponent;
  ...
  static TagsComponent loadTagsComponent(@Nullable ClassLoader classLoader) {
    try {
      ...
      return Provider.createInstance(
          Class.forName("org.apache.ratis.shaded.io.opencensus.impl.tags.TagsComponentImpl", true, classLoader),
          TagsComponent.class);
    ...
    try {
      // Call Class.forName with literal string name of the class to help shading tools.
      return Provider.createInstance(
          Class.forName("org.apache.ratis.shaded.io.opencensus.impllite.tags.TagsComponentImplLite", true, classLoader),
          TagsComponent.class);
    } catch (ClassNotFoundException e) {
      logger.log(
          Level.FINE,
