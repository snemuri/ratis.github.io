 ...
 * under the License.
 */
package org.apache.ratis.shaded.io.netty.util.internal;
...
import static org.apache.ratis.shaded.io.netty.util.internal.PlatformDependent0.HASH_CODE_ASCII_SEED;
import static org.apache.ratis.shaded.io.netty.util.internal.PlatformDependent0.HASH_CODE_C1;
import static org.apache.ratis.shaded.io.netty.util.internal.PlatformDependent0.HASH_CODE_C2;
import static org.apache.ratis.shaded.io.netty.util.internal.PlatformDependent0.hashCodeAsciiSanitize;
import static org.apache.ratis.shaded.io.netty.util.internal.PlatformDependent0.unalignedAccess;
 ...
 * the system property <strong>org.apache.ratis.shaded.io.netty.noUnsafe</strong>.
 */
public final class PlatformDependent {
    ...
    private static final boolean DIRECT_BUFFER_PREFERRED =
            HAS_UNSAFE && !SystemPropertyUtil.getBoolean("org.apache.ratis.shaded.io.netty.noPreferDirect", false);
    ...
    static {
        ...
        long maxDirectMemory = SystemPropertyUtil.getLong("org.apache.ratis.shaded.io.netty.maxDirectMemory", -1);
        ...
        int tryAllocateUninitializedArray =
                SystemPropertyUtil.getInt("org.apache.ratis.shaded.io.netty.uninitializedArrayAllocationThreshold", 1024);
    ...
    private static File tmpdir0() {
        File f;
        try {
            f = toDirectory(SystemPropertyUtil.get("org.apache.ratis.shaded.io.netty.tmpdir"));
            if (f != null) {
    ...
    private static int bitMode0() {
        ...
        int bitMode = SystemPropertyUtil.getInt("org.apache.ratis.shaded.io.netty.bitMode", 0);
        if (bitMode > 0) {
