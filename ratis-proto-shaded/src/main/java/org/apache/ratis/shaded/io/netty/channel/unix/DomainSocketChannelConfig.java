...
public interface DomainSocketChannelConfig extends ChannelConfig {
     ...
     * {@link org.apache.ratis.shaded.io.netty.channel.Channel} and passed through the pipeline. If
     * {@link DomainSocketReadMode#FILE_DESCRIPTORS} is used
     * {@link FileDescriptor}s will be passed through the {@link org.apache.ratis.shaded.io.netty.channel.ChannelPipeline}.
     *
