...
import org.apache.ratis.shaded.io.opencensus.internal.BaseMessageEventUtil;
...
public abstract class SpanData {
  ...
  public static SpanData create(
      ...
      TimedEvents<? extends org.apache.ratis.shaded.io.opencensus.trace.BaseMessageEvent> messageOrNetworkEvents,
      Links links,
    ...
    for (TimedEvent<? extends org.apache.ratis.shaded.io.opencensus.trace.BaseMessageEvent> timedEvent :
        messageOrNetworkEvents.getEvents()) {
      org.apache.ratis.shaded.io.opencensus.trace.BaseMessageEvent event = timedEvent.getEvent();
  ...
  @Deprecated
  @SuppressWarnings({"deprecation"})
  public TimedEvents<org.apache.ratis.shaded.io.opencensus.trace.NetworkEvent> getNetworkEvents() {
    TimedEvents<MessageEvent> timedEvents = getMessageEvents();
    List<TimedEvent<org.apache.ratis.shaded.io.opencensus.trace.NetworkEvent>> networkEventsList = Lists.newArrayList();
    for (TimedEvent<MessageEvent> timedEvent : timedEvents.getEvents()) {
      networkEventsList.add(
          TimedEvent.<org.apache.ratis.shaded.io.opencensus.trace.NetworkEvent>create(
              timedEvent.getTimestamp(),
              BaseMessageEventUtil.asNetworkEvent(timedEvent.getEvent())));
    }
    return TimedEvents.<org.apache.ratis.shaded.io.opencensus.trace.NetworkEvent>create(
