 ...
 * stream messages. It is used for all {@link org.apache.ratis.shaded.io.grpc.MethodDescriptor.MethodType}, including
...
public interface StreamObserver<V>  {
   ...
   * allowed.
   *
   * <p>{@code t} should be a {@link org.apache.ratis.shaded.io.grpc.StatusException} or {@link
   * org.apache.ratis.shaded.io.grpc.StatusRuntimeException}, but other {@code Throwable} types are possible. Callers should
   * generally convert from a {@link org.apache.ratis.shaded.io.grpc.Status} via {@link org.apache.ratis.shaded.io.grpc.Status#asException()} or
   * {@link org.apache.ratis.shaded.io.grpc.Status#asRuntimeException()}. Implementations should generally convert to a
   * {@code Status} via {@link org.apache.ratis.shaded.io.grpc.Status#fromThrowable(Throwable)}.
   *
