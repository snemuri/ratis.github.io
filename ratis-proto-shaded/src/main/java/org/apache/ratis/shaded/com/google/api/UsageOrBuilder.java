...
public interface UsageOrBuilder extends
   ...
   */
  java.util.List<org.apache.ratis.shaded.com.google.api.UsageRule> 
      getRulesList();
  /**
   * <pre>
   * A list of usage rules that apply to individual API methods.
   ...
   * <code>repeated .google.api.UsageRule rules = 6;</code>
   */
  org.apache.ratis.shaded.com.google.api.UsageRule getRules(int index);
  /**
   * <pre>
   * A list of usage rules that apply to individual API methods.
   * **NOTE:** All service configuration rules follow "last one wins" order.
   ...
   * <code>repeated .google.api.UsageRule rules = 6;</code>
   */
  java.util.List<? extends org.apache.ratis.shaded.com.google.api.UsageRuleOrBuilder> 
   ...
   * <code>repeated .google.api.UsageRule rules = 6;</code>
   */
  org.apache.ratis.shaded.com.google.api.UsageRuleOrBuilder getRulesOrBuilder(
      int index);
