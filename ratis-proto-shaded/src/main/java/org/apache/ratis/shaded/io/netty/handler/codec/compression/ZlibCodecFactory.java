...
public final class ZlibCodecFactory {
    ...
    static {
        noJdkZlibDecoder = SystemPropertyUtil.getBoolean("org.apache.ratis.shaded.io.netty.noJdkZlibDecoder",
                PlatformDependent.javaVersion() < 7);
        logger.debug("-Dio.netty.noJdkZlibDecoder: {}", noJdkZlibDecoder);

        noJdkZlibEncoder = SystemPropertyUtil.getBoolean("org.apache.ratis.shaded.io.netty.noJdkZlibEncoder", false);
