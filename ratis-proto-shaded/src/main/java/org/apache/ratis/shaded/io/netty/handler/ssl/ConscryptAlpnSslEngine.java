...
import static org.apache.ratis.shaded.io.netty.handler.ssl.SslUtils.toSSLHandshakeException;
...
import org.apache.ratis.shaded.io.netty.handler.ssl.JdkApplicationProtocolNegotiator.ProtocolSelectionListener;
import org.apache.ratis.shaded.io.netty.handler.ssl.JdkApplicationProtocolNegotiator.ProtocolSelector;
...
abstract class ConscryptAlpnSslEngine extends JdkSslEngine {
    private static final boolean USE_BUFFER_ALLOCATOR = SystemPropertyUtil.getBoolean(
            "org.apache.ratis.shaded.io.netty.handler.ssl.conscrypt.useBufferAllocator", true);
