        ...
        DefaultResourceLeakDetectorFactory() {
            ...
            try {
                customLeakDetector = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                        return SystemPropertyUtil.get("org.apache.ratis.shaded.io.netty.customResourceLeakDetector");
                    }
                });
            } catch (Throwable cause) {
                logger.error("Could not access System property: org.apache.ratis.shaded.io.netty.customResourceLeakDetector", cause);
