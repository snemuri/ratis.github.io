...
import org.apache.ratis.shaded.io.opencensus.common.Clock;
import org.apache.ratis.shaded.io.opencensus.internal.Provider;
import org.apache.ratis.shaded.io.opencensus.trace.config.TraceConfig;
import org.apache.ratis.shaded.io.opencensus.trace.export.ExportComponent;
import org.apache.ratis.shaded.io.opencensus.trace.propagation.PropagationComponent;
  ...
  static TraceComponent loadTraceComponent(@Nullable ClassLoader classLoader) {
    try {
      ...
      return Provider.createInstance(
          Class.forName("org.apache.ratis.shaded.io.opencensus.impl.trace.TraceComponentImpl", true, classLoader),
    ...
    try {
      // Call Class.forName with literal string name of the class to help shading tools.
      return Provider.createInstance(
          Class.forName("org.apache.ratis.shaded.io.opencensus.impllite.trace.TraceComponentImplLite", true, classLoader),
          TraceComponent.class);
    } catch (ClassNotFoundException e) {
      logger.log(
          Level.FINE,
