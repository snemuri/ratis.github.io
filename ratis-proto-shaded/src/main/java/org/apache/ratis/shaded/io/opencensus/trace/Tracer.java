...
import org.apache.ratis.shaded.io.opencensus.trace.SpanBuilder.NoopSpanBuilder;
 ...
 *
 * <p>The automatic context propagation is done using {@link org.apache.ratis.shaded.io.grpc.Context} which is a gRPC
 ...
 * {@link org.apache.ratis.shaded.io.grpc.Context} between different threads.
 *
...
public abstract class Tracer {
   ...
   *
   * <p>IMPORTANT: Caller must manually propagate the entire {@code org.apache.ratis.shaded.io.grpc.Context} when wraps a
   ...
   *
   * <p>Example with Executor wrapped with {@link org.apache.ratis.shaded.io.grpc.Context#currentContextExecutor}:
   *
   * <pre><code>
   * class MyClass {
   *   private static Tracer tracer = Tracing.getTracer();
   ...
   * </code></pre>
   *
   * <p>Example without Executor wrapped with {@link org.apache.ratis.shaded.io.grpc.Context#currentContextExecutor}:
   *
   * <pre><code>
   * class MyClass {
   *   private static Tracer tracer = Tracing.getTracer();
