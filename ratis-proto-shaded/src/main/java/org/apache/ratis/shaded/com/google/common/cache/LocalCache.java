...
package org.apache.ratis.shaded.com.google.common.cache;

import static org.apache.ratis.shaded.com.google.common.base.Preconditions.checkNotNull;
import static org.apache.ratis.shaded.com.google.common.base.Preconditions.checkState;
import static org.apache.ratis.shaded.com.google.common.cache.CacheBuilder.NULL_TICKER;
import static org.apache.ratis.shaded.com.google.common.cache.CacheBuilder.UNSET_INT;
import static org.apache.ratis.shaded.com.google.common.util.concurrent.Futures.transform;
import static org.apache.ratis.shaded.com.google.common.util.concurrent.MoreExecutors.directExecutor;
import static org.apache.ratis.shaded.com.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
import static java.util.concurrent.TimeUnit.NANOSECONDS;

import org.apache.ratis.shaded.com.google.common.annotations.GwtCompatible;
import org.apache.ratis.shaded.com.google.common.annotations.GwtIncompatible;
import org.apache.ratis.shaded.com.google.common.annotations.VisibleForTesting;
import org.apache.ratis.shaded.com.google.common.base.Equivalence;
import org.apache.ratis.shaded.com.google.common.base.Stopwatch;
import org.apache.ratis.shaded.com.google.common.base.Ticker;
import org.apache.ratis.shaded.com.google.common.cache.AbstractCache.SimpleStatsCounter;
import org.apache.ratis.shaded.com.google.common.cache.AbstractCache.StatsCounter;
import org.apache.ratis.shaded.com.google.common.cache.CacheBuilder.NullListener;
import org.apache.ratis.shaded.com.google.common.cache.CacheBuilder.OneWeigher;
import org.apache.ratis.shaded.com.google.common.cache.CacheLoader.InvalidCacheLoadException;
import org.apache.ratis.shaded.com.google.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import org.apache.ratis.shaded.com.google.common.cache.LocalCache.AbstractCacheSet;
import org.apache.ratis.shaded.com.google.common.collect.AbstractSequentialIterator;
import org.apache.ratis.shaded.com.google.common.collect.ImmutableMap;
import org.apache.ratis.shaded.com.google.common.collect.ImmutableSet;
import org.apache.ratis.shaded.com.google.common.collect.Iterators;
import org.apache.ratis.shaded.com.google.common.collect.Maps;
import org.apache.ratis.shaded.com.google.common.collect.Sets;
import org.apache.ratis.shaded.com.google.common.primitives.Ints;
import org.apache.ratis.shaded.com.google.common.util.concurrent.ExecutionError;
import org.apache.ratis.shaded.com.google.common.util.concurrent.Futures;
...
import org.apache.ratis.shaded.com.google.common.util.concurrent.UncheckedExecutionException;
import org.apache.ratis.shaded.com.google.common.util.concurrent.Uninterruptibles;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code org.apache.ratis.shaded.com.google.common.collect.MapMaker})
  ...
  static class LoadingValueReference<K, V> implements ValueReference<K, V> {
    ...
    public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
      try {
        ...
        return transform(
            newValue,
            new org.apache.ratis.shaded.com.google.common.base.Function<V, V>() {
              @Override
