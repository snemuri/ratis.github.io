...
public final class MethodDescriptor<ReqT, RespT> {
  ...
  public enum MethodType {
     ...
     * after calling {@link ClientCall#start(org.apache.ratis.shaded.io.grpc.ClientCall.Listener, org.apache.ratis.shaded.io.grpc.Metadata)}
     * and then immediately half-close the stream by calling {@link org.apache.ratis.shaded.io.grpc.ClientCall#halfClose()}.
     *
     * @since 1.0.0
     */
     ...
     * upon receipt of {@link org.apache.ratis.shaded.io.grpc.ServerCall.Listener#onHalfClose()} and then immediately
     * close the stream by calling {@link ServerCall#close(Status, org.apache.ratis.shaded.io.grpc.Metadata)}.
     *
     * @since 1.0.0
     */
  ...
  public interface Marshaller<T> {
     ...
     * Where possible implementations should produce streams that are {@link org.apache.ratis.shaded.io.grpc.KnownLength}
   ...
   * {@code org.apache.ratis.shaded.io.grpc.protobuf.ProtoMethodDescriptorSupplier}.
   *
   * @since 1.7.0
   */
