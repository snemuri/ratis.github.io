 ...
 * under the License.
 */
package org.apache.ratis.shaded.io.netty.channel.sctp;
...
import static org.apache.ratis.shaded.io.netty.channel.sctp.SctpChannelOption.SCTP_INIT_MAXSTREAMS;
import static org.apache.ratis.shaded.io.netty.channel.sctp.SctpChannelOption.SCTP_NODELAY;
...
public class DefaultSctpChannelConfig extends DefaultChannelConfig implements SctpChannelConfig {
    ...
    public DefaultSctpChannelConfig(org.apache.ratis.shaded.io.netty.channel.sctp.SctpChannel channel, SctpChannel javaChannel) {
        super(channel);
        if (javaChannel == null) {
