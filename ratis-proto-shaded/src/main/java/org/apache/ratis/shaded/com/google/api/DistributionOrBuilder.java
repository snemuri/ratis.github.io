...
public interface DistributionOrBuilder extends
   ...
   * <code>.google.api.Distribution.Range range = 4;</code>
   */
  org.apache.ratis.shaded.com.google.api.Distribution.Range getRange();
  /**
   * <pre>
   * If specified, contains the range of the population values. The field
   * must not be present if the `count` is zero.
   ...
   * <code>.google.api.Distribution.Range range = 4;</code>
   */
  org.apache.ratis.shaded.com.google.api.Distribution.RangeOrBuilder getRangeOrBuilder();
   ...
   * <code>.google.api.Distribution.BucketOptions bucket_options = 6;</code>
   */
  org.apache.ratis.shaded.com.google.api.Distribution.BucketOptions getBucketOptions();
  /**
   * <pre>
   * Defines the histogram bucket boundaries.
   * </pre>
   ...
   * <code>.google.api.Distribution.BucketOptions bucket_options = 6;</code>
   */
  org.apache.ratis.shaded.com.google.api.Distribution.BucketOptionsOrBuilder getBucketOptionsOrBuilder();
