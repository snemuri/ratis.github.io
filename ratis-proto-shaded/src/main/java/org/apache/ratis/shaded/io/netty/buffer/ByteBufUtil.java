...
import org.apache.ratis.shaded.io.netty.util.ByteProcessor;
import org.apache.ratis.shaded.io.netty.util.CharsetUtil;
import org.apache.ratis.shaded.io.netty.util.Recycler;
import org.apache.ratis.shaded.io.netty.util.Recycler.Handle;
...
import static org.apache.ratis.shaded.io.netty.util.internal.MathUtil.isOutOfBounds;
...
import static org.apache.ratis.shaded.io.netty.util.internal.StringUtil.isSurrogate;
...
public final class ByteBufUtil {
    ...
    static {
        String allocType = SystemPropertyUtil.get(
                "org.apache.ratis.shaded.io.netty.allocator.type", PlatformDependent.isAndroid() ? "unpooled" : "pooled");
        ...
        THREAD_LOCAL_BUFFER_SIZE = SystemPropertyUtil.getInt("org.apache.ratis.shaded.io.netty.threadLocalDirectBufferSize", 64 * 1024);
        logger.debug("-Dio.netty.threadLocalDirectBufferSize: {}", THREAD_LOCAL_BUFFER_SIZE);

        MAX_CHAR_BUFFER_SIZE = SystemPropertyUtil.getInt("org.apache.ratis.shaded.io.netty.maxThreadLocalCharBufferSize", 16 * 1024);
