...
public class ClientInterceptors {
  ...
  /**
   * A {@link org.apache.ratis.shaded.io.grpc.ForwardingClientCall} that delivers exceptions from its start logic to the
   * call listener.
   *
  ...
  public abstract static class CheckedForwardingClientCall<ReqT, RespT>
      extends org.apache.ratis.shaded.io.grpc.ForwardingClientCall<ReqT, RespT> {
