...
import static org.apache.ratis.shaded.io.grpc.internal.GrpcUtil.DEFAULT_MAX_MESSAGE_SIZE;
import static org.apache.ratis.shaded.io.grpc.internal.GrpcUtil.DEFAULT_SERVER_KEEPALIVE_TIMEOUT_NANOS;
import static org.apache.ratis.shaded.io.grpc.internal.GrpcUtil.DEFAULT_SERVER_KEEPALIVE_TIME_NANOS;
...
import org.apache.ratis.shaded.io.grpc.internal.AbstractServerImplBuilder;
...
import org.apache.ratis.shaded.io.netty.channel.ServerChannel;
...
public final class NettyServerBuilder extends AbstractServerImplBuilder<NettyServerBuilder> {
   ...
   *
   * <p>Grpc uses non-daemon {@link Thread}s by default and thus a {@link org.apache.ratis.shaded.io.grpc.Server} will
   ...
   * A simple solution to this problem is to call {@link org.apache.ratis.shaded.io.grpc.Server#awaitTermination()} to
