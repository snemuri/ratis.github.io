...
import org.apache.ratis.shaded.io.netty.buffer.CompositeByteBuf;
import org.apache.ratis.shaded.io.netty.buffer.Unpooled;
import org.apache.ratis.shaded.io.netty.channel.AbstractCoalescingBufferQueue;
import org.apache.ratis.shaded.io.netty.channel.Channel;
import org.apache.ratis.shaded.io.netty.channel.ChannelConfig;
import org.apache.ratis.shaded.io.netty.channel.ChannelException;
...
import org.apache.ratis.shaded.io.netty.channel.ChannelInboundHandler;
...
import org.apache.ratis.shaded.io.netty.handler.codec.UnsupportedMessageTypeException;
...
import org.apache.ratis.shaded.io.netty.util.concurrent.DefaultPromise;
...
import org.apache.ratis.shaded.io.netty.util.concurrent.FutureListener;
import org.apache.ratis.shaded.io.netty.util.concurrent.ImmediateExecutor;
...
import static org.apache.ratis.shaded.io.netty.buffer.ByteBufUtil.ensureWritableSuccess;
import static org.apache.ratis.shaded.io.netty.handler.ssl.SslUtils.getEncryptedPacketLength;
    ...
    private boolean ignoreException(Throwable t) {
        if (!(t instanceof SSLException) && t instanceof IOException && sslClosePromise.isDone()) {
            ...
            for (StackTraceElement element: elements) {
                ...
                // skip all classes that belong to the org.apache.ratis.shaded.io.netty package
                if (classname.startsWith("org.apache.ratis.shaded.io.netty.")) {
                    continue;
                }
