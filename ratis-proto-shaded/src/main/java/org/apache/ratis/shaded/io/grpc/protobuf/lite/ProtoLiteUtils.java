...
package org.apache.ratis.shaded.io.grpc.protobuf.lite;
...
import org.apache.ratis.shaded.com.google.protobuf.Parser;
import org.apache.ratis.shaded.io.grpc.ExperimentalApi;
import org.apache.ratis.shaded.io.grpc.KnownLength;
import org.apache.ratis.shaded.io.grpc.Metadata;
import org.apache.ratis.shaded.io.grpc.MethodDescriptor.Marshaller;
import org.apache.ratis.shaded.io.grpc.MethodDescriptor.PrototypeMarshaller;
...
public class ProtoLiteUtils {
  ...
  /**
   * The same value as {@link org.apache.ratis.shaded.io.grpc.internal.GrpcUtil#DEFAULT_MAX_MESSAGE_SIZE}.
   */
  @VisibleForTesting
  ...
  static long copy(InputStream from, OutputStream to) throws IOException {
    // Copied from guava org.apache.ratis.shaded.com.google.common.io.ByteStreams because its API is unstable (beta)
    checkNotNull(from);
    checkNotNull(to);
