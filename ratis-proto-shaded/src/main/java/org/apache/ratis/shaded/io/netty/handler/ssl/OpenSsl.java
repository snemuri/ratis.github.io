...
import org.apache.ratis.shaded.io.netty.internal.tcnative.Library;
import org.apache.ratis.shaded.io.netty.internal.tcnative.SSL;
import org.apache.ratis.shaded.io.netty.internal.tcnative.SSLContext;
...
import static org.apache.ratis.shaded.io.netty.handler.ssl.SslUtils.DEFAULT_CIPHER_SUITES;
import static org.apache.ratis.shaded.io.netty.handler.ssl.SslUtils.addIfSupported;
import static org.apache.ratis.shaded.io.netty.handler.ssl.SslUtils.useFallbackCiphersIfDefaultIsEmpty;
...
public final class OpenSsl {
    ...
    static {
        ...
        try {
            Class.forName("org.apache.ratis.shaded.io.netty.internal.tcnative.SSL", false, OpenSsl.class.getClassLoader());
                                ...
                                useKeyManagerFactory = AccessController.doPrivileged(new PrivilegedAction<Boolean>() {
                                    ...
                                    public Boolean run() {
                                        return SystemPropertyUtil.getBoolean(
                                                "org.apache.ratis.shaded.io.netty.handler.ssl.openssl.useKeyManagerFactory", true);
                                    }
                                });
                            } catch (Throwable ignore) {
