  ...
  static StatsComponent loadStatsComponent(@Nullable ClassLoader classLoader) {
    try {
      ...
      return Provider.createInstance(
          Class.forName("org.apache.ratis.shaded.io.opencensus.impl.stats.StatsComponentImpl", true, classLoader),
    ...
    try {
      // Call Class.forName with literal string name of the class to help shading tools.
      return Provider.createInstance(
          Class.forName("org.apache.ratis.shaded.io.opencensus.impllite.stats.StatsComponentImplLite", true, classLoader),
          StatsComponent.class);
    } catch (ClassNotFoundException e) {
      logger.log(
          Level.FINE,
