...
import org.apache.ratis.shaded.io.grpc.Attributes.Key;
...
public interface CallCredentials {
  ...
  public static final Key<SecurityLevel> ATTR_SECURITY_LEVEL =
      Key.of("org.apache.ratis.shaded.io.grpc.CallCredentials.securityLevel");
   ...
   * org.apache.ratis.shaded.io.grpc.CallOptions} with increasing precedence.
   */
  @ExperimentalApi("https://github.com/grpc/grpc-java/issues/1914")
  public static final Key<String> ATTR_AUTHORITY = Key.of("org.apache.ratis.shaded.io.grpc.CallCredentials.authority");
