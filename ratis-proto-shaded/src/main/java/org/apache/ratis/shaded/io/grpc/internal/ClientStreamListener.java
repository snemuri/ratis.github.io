...
public interface ClientStreamListener extends StreamListener {
   ...
   * {@link #closed(org.apache.ratis.shaded.io.grpc.Status, Metadata)} is called.
   *
   ...
   * org.apache.ratis.shaded.io.grpc.Status.Code#OK} is the only status code that is guaranteed
