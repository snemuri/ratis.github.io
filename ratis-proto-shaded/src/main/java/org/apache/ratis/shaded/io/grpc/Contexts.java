...
public final class Contexts {
  ...
  /**
   * Implementation of {@link org.apache.ratis.shaded.io.grpc.ForwardingServerCallListener} that attaches a context before
  ...
  public static Status statusFromCancelled(Context context) {
    ...
    if (cancellationCause == null) {
      return Status.CANCELLED.withDescription("org.apache.ratis.shaded.io.grpc.Context was cancelled without error");
    }
